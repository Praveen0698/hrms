...
const CompanyForm = () => {
    ...
    const { file,setFile,dateError,formData,setFormVisible,errorMsg,isValidCIN,addressError,isEmailValid,phoneError,websiteError,isValidGSTNumber,isValidUANNumber,errorCode,company,setIsValidCIN,setIsEmailValid,setIsValidUANNumber,setPhoneError,setIsValidGSTNumber,setWebsiteError,setDateError,setFormData,setErrorCode,setErrorMsg,setCompanyName,setAddressError,setZipCode,setAddress,setCompany} = StateCompany()
