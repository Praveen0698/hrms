...
import * as bankapi from "../Bank/bankapi";
...
const BankForm = () => {
    ...
    const {formData,setFormData,formVisible,setFormVisible,toggle,setToggle,addbank,setAddBank, open, setOpen, bankNameError, accountName, setBankNameError,   accountNameError, setAccountNameError, accountNumber,accountNumberError, setAccountNumberError, branchNameError, setBranchNameError,recDelete, setRecDelete} = BankState();
    ...
    const handleInputChange = (e) => {
      ...
      if (name === 'bankName') {
        ...
        if (!isRequired) {
          ...
          setAccountNameError('Account Name should only contain alphabetic characters');
        } else if (!isValidSize) {
          setAccountNameError('Account Name should be between 2 and 100 characters');
        } else {
          setAccountNameError('');
        }
        ...
        if (!isRequired) {
          ...
          setAccountNumberError('Account Number should be numeric with at least 15 digits');
        } else {
        ...
        if (!isRequired) {
          ...
          setBranchNameError('Branch Name should only contain alphabetic characters');
        } else if (!isValidSize) {
          setBranchNameError('Branch Name should be between 2 and 100 characters');
        } else {
          setBranchNameError('');
        }
      }
    ...
    const saveAddbank = async () => {
      ...
      alert("AddBank added successfully");
      navigate("/dashboard ");
    ...
    <form onSubmit={handleSubmit}>
                      ...
                      <div className="data-buttons">
                        ...
                        <Button id="input-btn"
                          ...
                          disabled={Boolean(bankNameError)}
                        >
                          Submit
                        </Button>
                        <Button id="input-btn"
